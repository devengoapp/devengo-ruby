...
RSpec.describe Devengo::API::AuthService, :integration, type: :api do
  ...
  describe "login" do
    ...
    it "token with expected data", authenticate: false do
      ...
      expect(tokens.access_token.value).to eq "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoibWFuXzdQMkhhUGFjNms4R1g1T3J6eDA2MEYiLCJ1c2VyX3R5cGUiOiJNYW5hZ2VyIiwiY29tcGFueV9pZCI6bnVsbCwiZXhwIjoiMTY3NjA3NDkyMyJ9.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" # rubocop:disable Layout/LineLength
